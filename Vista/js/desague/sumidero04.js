...
export class Sumidero04 extends SingleShapeBase {
  constructor(ctx, color, options = {}) {
    ...
    this.label = `Sumidero Tipo Rejilla Ø4`;

    // Configurar dimensiones y colores a partir de opciones o usar valores por defecto
    this.largerCircleRadius = options.largerCircleRadius || 3.2; // Radio del círculo más grande en mm
    this.squareSize = options.squareSize || this.largerCircleRadius * 2 + 3.5; // Tamaño del cuadro
    this.lineLength = options.lineLength || 6; // Longitud de las líneas en mm
    this.uShapeHorizontal = options.uShapeHorizontal || 7; // Longitud horizontal de la "U" en mm
    this.uShapeVertical = options.uShapeVertical || 11.5; // Longitud vertical de la "U" en mm
  ...
  drawLineWithCircle(x, y) {
    ...
    this.ctx.strokeStyle = "#FF00FF"; // Color del borde del cuadro
    this.ctx.stroke();
    ...
    this.ctx.lineWidth = 1.5;
    this.ctx.strokeStyle = "#FF00FF"; // Color de borde verde para el círculo más grande
    this.ctx.stroke();
  ...
  drawUShape(centerX, centerY) {
    ...
    this.ctx.strokeStyle = "#FF0000"; // Color para la forma "U"
    this.ctx.lineWidth = 1.5;
    this.ctx.stroke();
  ...
  drawTShape(centerX, centerY) {
    ...
    this.ctx.lineWidth = 1.5;
    this.ctx.strokeStyle = "#FF0000"; // Color para la parte vertical de la "T"
    this.ctx.stroke();
