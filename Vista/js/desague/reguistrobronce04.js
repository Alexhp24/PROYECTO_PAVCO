...
export class ReguistroBronce04 extends SingleShapeBase {
  ...
  drawLineWithCircle(x, y) {
    ...
    this.ctx.strokeStyle = "#8B0000"; // Color de borde verde para el círculo más grande
    this.ctx.stroke();
    ...
    this.ctx.lineWidth = 2.5;
    this.ctx.strokeStyle = "#8B0000"; // Color rojo para la línea inclinada
    this.ctx.stroke();
