...
class Usuario {
    ...
    function Logearse($email,$pass){
        $sql = "SELECT id_usuario,nombre,apellido,dni,roles_designado FROM adm_usuario inner join adm_roles on roles_designado=id_roles WHERE  usuario=:email and password_conf=:pass";
