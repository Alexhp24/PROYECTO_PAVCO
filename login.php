            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form action="../Controlador/usuarioControlador.php" method="post">
                        ...
                        <!-- Password input -->
                        <div data-mdb-input-init class="form-outline mb-3 text-center">
                        ...
                        <div class="text-center text-lg-center mt-4 pt-2">
                            <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Iniciar session</button>
                        </div>
                    </form>
                </div>
            </div>
